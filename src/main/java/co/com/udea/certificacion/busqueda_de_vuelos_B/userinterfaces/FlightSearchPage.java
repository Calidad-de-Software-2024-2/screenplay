...
public class FlightSearchPage extends PageObject {
    ...
    public static final Target DEPARTURE_ONLY_DIV = Target.the("Fecha de salida")
            .locatedBy("/html/body/div[2]/div/div");
    public static final Target DEPARTURE_DIV = Target.the("Fecha de salida")
            .locatedBy("/html/body/div[2]/div/div/div[1]");
    public static final Target RETURN_DIV = Target.the("Fecha de retorno")
